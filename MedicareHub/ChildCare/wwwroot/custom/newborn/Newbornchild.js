(function ($) {
    function NewBornChild() {

        var $this = this, formAddEditTreatment;
        function initializeGrid() {
            var gridProvider = new Global.GridHelper('#grid-newborn-list', {
                "columnDefs": [
                    {
                        "targets": [0],
                        "visible": false
                    ...
                    //},
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            var actionLink = $("<a/>", {
                                href: "/User/Newborn/AddEditNewborn" + row[0],
                                id: "editTypeModal",
                                class: "btn btn-success btn-sm",
                                oncontextmenu: 'return false',
                                'data-bs-toggle': "modal",
                                'data-bs-target': "#modal-add-edit-newborn",
                                html: $("<i/>", {
                                    class: "bi bi-pencil-square", title: "Edit Newborn"
                                }),
                            ...
                            actionLink += $("<a/>", {
                                ...
                                oncontextmenu: 'return false',
                                'data-bs-toggle': "modal",
                                'data-bs-target': "#modal-delete-newborn",
                                html: $("<i/>", {
                                    class: "bi bi-trash", title: "Delete Newborn"
                                }),
                            }).append().get(0).outerHTML + "&nbsp;"
        ...
        function initilizeModel() {
            $("#modal-add-edit-newborn").on('shown.bs.modal', function (event) {
                var button = $(event.relatedTarget);
                var recipient1 = $(button).attr("href");
                $('#modal-add-edit-newborn .modal-content').load(recipient1, function () {
            ...
            $("#modal-delete-newborn").on('shown.bs.modal', function (event) {
                var button = $(event.relatedTarget);
                var recipient1 = $(button).attr("href");
                $('#modal-delete-newborn .modal-content').load(recipient1, function () {
