...
namespace ChildCare.Areas.SuperAdmin.Controllers
{
    ...
    public class ClinicManagerController : BaseController
    {
        ...
        public ClinicManagerController(IDashboardService dashboardservice)
        {
        ...
        public async Task<DataTableResultExt>Index(ChildCareCore.Helper.DataTableExtend dataTable, UserSpecification model)
        {
            ...
            var doctorlist = returndata.Data!.Where(x => x.UserRoleId == 2).ToList();
        ...
        [HttpGet]
         public IActionResult AddEditClinic(Guid ?Id)
        {

            RegistrationViewModel model = new RegistrationViewModel();

            return PartialView("_AddEditClinic",model);
        }
